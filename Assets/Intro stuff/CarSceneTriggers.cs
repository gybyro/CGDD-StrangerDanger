...
public class CarSceneTriggers : MonoBehaviour
{
    ...
    IEnumerator PlaySat()
    {
        switch (carTick)
        {
            case 17:  yield return PlayMon01(); break; // morning
            case 18:  yield return PlayMon02(); break; // evening
            case 19:  yield return PlayMon03(); break; // dusk
    ...
    IEnumerator PlaySun()
    {
        switch (carTick)
        {
            case 20:  yield return PlayMon01(); break; // morning
            case 21:  yield return PlayMon02(); break; // evening
            case 22:  yield return PlayMon03(); break; // dusk
